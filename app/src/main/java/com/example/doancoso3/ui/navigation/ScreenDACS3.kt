...
sealed class ScreenDACS3(val route: String) {
    ...
    object CheckOut: ScreenDACS3("checkout_screen")
    object Success: ScreenDACS3("success_screen")
    object Login: ScreenDACS3("login_screen")
    object Signup: ScreenDACS3("signup_screen")
}